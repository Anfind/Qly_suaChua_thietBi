-- Hệ thống quản lý sửa chữa thiết bị (PHIÊN BẢN CẬP NHẬT)
-- Tạo database
...
-- Bảng nội dung sửa chữa template (MỚI)
...
-- Chèn dữ liệu repair_contents mẫu
...
-- Chèn dữ liệu system_settings mặc định
